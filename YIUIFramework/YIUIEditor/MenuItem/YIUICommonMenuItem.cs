...
namespace YIUIFramework.Editor
{
    ...
    {
        static void CreateTarget(string targetName)
        {
            ...
            var path = $"{UIConst.FrameworkPath}/YIUIEditor/TemplatePrefabs/YIUI/{targetName}.prefab";
        ...
        static void CreateButton_NoText()
        {
