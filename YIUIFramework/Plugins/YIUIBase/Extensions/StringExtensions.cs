...
namespace YIUIFramework
{
    ...
    public static class StringExtensions
    {
        ...
        public static bool IsInteger(this string val)
        {
            ...
            bool isNum = Int32.TryParse(val, NumberStyles.Any, NumberFormatInfo.InvariantInfo, out _);
            return isNum;
        }
        ...
        {
            var parameters = new CspParameters { KeyContainerName = key };
            var rsaServiceProvider = new RSACryptoServiceProvider(parameters) { PersistKeyInCsp = true };
