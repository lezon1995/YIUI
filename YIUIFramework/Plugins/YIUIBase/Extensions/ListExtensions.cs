...
namespace YIUIFramework
{
    public static partial class ListExtensions
    {
        ...
        public static void Shuffle<T>(this IList<T> array)
        {
            ...
            {
                var randIdx = UnityEngine.Random.Range(0, array.Count);
        ...
        /// <returns></returns>
        public static Dictionary<TKey, TItem> ToDictionary<TKey, TItem>(this IList<TItem> list,
            Func<TItem, TKey> getKeyHandler)
        {
            if (list == null)
            {
        ...
        public static int IndexOf<T>(this IList<T> list, T value, int start = 0, int count = 0,
            Func<T, T, bool> equalsFun = null)
        {
            count = count < 1
                ? list.Count
