...
namespace YIUIFramework
{
    ...
    {
        Dictionary<long, AsyncLockComponent> m_SemaphoreSlims = new Dictionary<long, AsyncLockComponent>();
        Dictionary<long, int> m_SemaphoreSlimsRefCount = new Dictionary<long, int>();
